class Solution {
    public int ladderLength(String beginWord, String endWord, List<String> wordList) {
        ...
        visit.add(beginWord); //Forgot to use visit set leading Time Limit Exceeded.
        q.add(beginWord);
        int res = 1;
        while(!q.isEmpty()){
            int len = q.size();
        ...
        return 0; //Forgot to return 0 from here since if res not
        // returned from inside BFS means not possible to go
        // from begin to end
    }
}
